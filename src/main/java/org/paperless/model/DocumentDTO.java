...
public class DocumentDTO {
    ...
    public GetDocuments200ResponseResultsInner toGetDocumentInnerResponse() {
        GetDocuments200ResponseResultsInner result = new GetDocuments200ResponseResultsInner();
        result.setId(id);
        result.setCorrespondent(correspondent.orElse(null));
        result.setDocumentType(documentType.orElse(null));
        result.setStoragePath(storagePath.orElse(null));
        result.setTitle(title.orElse(null));
        result.setContent(content.orElse(null));
        result.setTags(tags.orElse(null));
        result.setCreated(created == null ? null : created.toString());
        result.setCreatedDate(createdDate == null ? null : createdDate.toString());
        result.setModified(modified == null ? null : modified.toString());
        result.setAdded(added == null ? null : added.toString());
        result.setArchiveSerialNumber(archiveSerialNumber.isPresent() ? Integer.valueOf(archiveSerialNumber.get()) : null);
        result.setOriginalFileName(originalFileName.orElse(null));
        result.setArchivedFileName(archivedFileName.orElse(null));
        result.setOwner(1);
        result.setUserCanChange(true);
        return result;
    }
}
